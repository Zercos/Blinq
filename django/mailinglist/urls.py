...
urlpatterns = [
    ...
    path('<uuid:pk>/manage', views.DetailMailingListView.as_view(), name='manage_mailinglist'),
    ...
    path('api/v1/mailinglist', views.MailingListCreateListView.as_view(), name='api-mailing-list-list'),
    path('api/v1/mailinglist/<uuid:pk>', views.MailingListRetrieveUpdateDestroyView.as_view(),
         name='api-mailing-list-detail'),
    path('api/v1/mailinglist/<uuid:mailing_list_pk>/subscribers', views.SubscriberListCreateView.as_view(),
